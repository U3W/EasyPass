...
class ChallengeForUserAuth(val decryptedChallenge: String, private val challengeTimeout: Int = 30000, private val timeCreated: LocalDateTime = LocalDateTime.now()) {
