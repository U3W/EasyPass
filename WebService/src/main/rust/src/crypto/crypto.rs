...
pub fn password_to_existing_key<'a>(password: &str, encrypted_key: &str) -> &'a[u8]{
...
pub fn password_and_second_factor_to_key<'a>(password: &str, encrypted_master_key: &str, second_factor: &str) -> &'a[u8]{
