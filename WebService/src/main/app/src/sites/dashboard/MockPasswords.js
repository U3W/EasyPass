...
class MockPasswords {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            easyPass: [{id: 6, tabID: 1, title: "Confluence", user: "swahl", url: "https://confluence.welsch.pro/", cat: 2, tag: [{"Wozu": "Hehehe"}]}],
            ...
            pass: [{id: 0, pass: "supergeheim" }, {id: 1, pass: "supergeheim" }, {id: 2, pass: "supergeheim" }, {id: 3, pass: "supergeheim" }, {id: 4, pass: "supergeheim" }, {id: 5, pass: "supergeheim" }, {id: 6, pass: "supergeheim" }, {id: 7, pass: "HelloooooooWorld"}],
        };
    ...
    getCats(tabselected) {
        ...
        switch (tabselected) {
            case tabs.PRIVPASS:
                ...
                break;
            case tabs.GROUPPASS:
                out = [{id:3, name:"EasyPass", desc:"Huiiii"} ];
                break;
        }
        return out;
    }
