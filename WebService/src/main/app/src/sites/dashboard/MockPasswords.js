...
class MockPasswords {
    ...
    constructor(props) {
        ...
        this.state = {
            sozialMedia: [{id: 0, title: "Google", user: "Sebooo@gmail.com", url: "google.com", cat: 1, tag: []}, {id: 1, title: "Instagram", user: "Sebo", pass: "Geheim", url: "instagram.com/", cat: 1, tag: [{"Kommentar": "Für die Werbebilder"}]},{id: 2, title: "Youtube", user: "michael.meyer@gmail.com", pass: "Geheim", url: "youtube.com", cat: 1, tag: [{"Kommentar": "Werbevideos"}]}],
