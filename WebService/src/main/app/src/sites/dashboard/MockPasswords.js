...
class MockPasswords {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            sonstige: [{id: 7, tabID: 0, title: "W3Schools", user: "w4235f", url: "https://www.w3schools.com/", cat: 0, tag: []}, {id: 8, tabID: 1, title: "Sup", user: "max.sup", url: "https://www.supremenewyork.com/", cat: 0, tag: []}],
